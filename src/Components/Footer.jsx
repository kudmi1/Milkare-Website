...
export default function Footer() {
	...
	return (
		<div className='footer w-full flex h-52 flex-col items-center border-t border-t-[#3b3b3b] bg-gradient-to-r from-mainGray via-[#2b2b2b] to-mainGray backdrop-blur-[10px]'>
