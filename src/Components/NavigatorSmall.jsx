	...
	return (
		<div className='overflow relative flex h-10 w-full items-center lg:hidden'>
			<nav className='mynav black z-[20] flex h-full w-full items-center justify-center '>
				...
				<NavLink
					to='/'
					className={`home-link overflow-hidden active:bg-activeButton border rounded-t-lg nav-text z-10 flex h-full w-1/3 border-transparent cursor-pointer items-center justify-center px-4 text-center
				...
				<NavLink
					to='/price'
					className={`price-link overflow-hidden active:bg-activeButton border rounded-t-lg nav-text z-10 flex h-full w-1/3 border-transparent cursor-pointer items-center justify-center px-4 text-center 
				...
				<NavLink
					to='/info'
					className={`info-link overflow-hidden active:bg-activeButton border rounded-t-lg nav-text z-10 flex h-full w-1/3 border-transparent cursor-pointer items-center justify-center px-4 text-center 
