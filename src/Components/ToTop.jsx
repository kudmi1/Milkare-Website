...
export default function ToTop({ position }) {
	...
	return (
		<div>
			<div
				className={`backdrop-blur-[10px] border border-thinLine to-top-btn fixed right-6 ${position} z-[39] h-12 w-12 md:h-16 md:w-16 rounded-full bg-[#212121d2] transition-colors${
					showTopBtn
