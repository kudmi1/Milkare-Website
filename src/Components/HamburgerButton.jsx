	...
	return (
		<div className='z-50 flex h-full items-center justify-end lg:hidden pr-4'>
			<button
				...
				className='hamburger-btn effect-shine flex overflow-hidden border border-transparent rounded-lg h-10 w-10 justify-center items-center active:bg-activeButton'
