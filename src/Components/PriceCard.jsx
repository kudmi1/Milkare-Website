...
export default function PriceCard({
	...
	const commonProps =
		'price-card-section mb-12 lg:mb-24 h-[650px] lg:h-[600px] bg-gradient-to-r from-[#323b5a] via-[#323b5ac4] to-[#323b5a] p-4 backdrop-blur-[10px] rounded-md w-full border border-[#3b3b3b]'
			...
			<div className='w-full md:w-[80%]'>
				...
				>
					...
					<div className='w-full lg:w-max py-6 text-center lg:text-start lg:pt-16'>
						<p
							className='pb-4 text-lg text-mainText lg:text-2xl rounded-lg border border-thinLine bg-[#2d3552] px-8 py-4'
