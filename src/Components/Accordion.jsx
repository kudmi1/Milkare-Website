...
export default function Accordion() {
	...
	return (
		...
		>
			...
			>
				<div className='w-full flex-col rounded-md border border-[#3b3b3b] bg-gradient-to-r from-mainGrayTransparent via-[#2b2b2b5b] to-mainGrayTransparent p-4 backdrop-blur-[10px]'>
					<h1
