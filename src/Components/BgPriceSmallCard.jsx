...
export const BgPriceSmallCard = ({ image, header, price, description }) => {
	...
	return (
		<div className='flex w-full flex-col text-mainText md:w-1/3'>
			<div className='flex h-full min-h-max flex-col justify-between rounded-lg border border-thinLine bg-gradient-to-t from-[#2c2649cc] to-[#1600419a] px-2 py-4 text-center  '>
				...
				<div className='bg-slate-600 w-full h-full rounded-md mt-4'>
					<img
						...
						alt=''
						className={` h-full w-full max-h-[280px] sm:max-h-[450px] rounded-md object-cover object-top md:max-h-[400px] ${
