...
export default function Profile() {
	...
	return (
		<footer className='absolute bottom-0 left-0 flex h-[300px] w-full flex-col items-center bg-gradient-to-r from-mainGray via-[#292929] to-mainGray lg:h-[300px] py-4'>
