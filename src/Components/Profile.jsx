...
export default function Profile() {
	...
	return (
		<footer className='absolute bottom-0 flex h-[300px] w-full flex-col items-center bg-gradient-to-b from-[#191924ef] to-[#1600419a] bg-opacity-80 py-4 text-mainText backdrop-blur-md lg:h-[300px]'>
