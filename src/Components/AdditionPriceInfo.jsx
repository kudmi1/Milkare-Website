...
export default function AdditionPriceInfo() {
	...
	return (
		...
		<div className={`${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'} transition-all duration-500 mb-12 w-full rounded-md border border-[#3b3b3b] bg-cardBg bg-opacity-60 px-4 py-6 md:px-12 lg:mb-24 lg:px-24 text-mainText`} >
			{language === 'english' ? (
				<>
