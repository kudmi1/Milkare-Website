...
export default function AdditionPriceInfo() {
	...
	return (
		<div className='mb-12 w-full rounded-md border border-[#3b3b3b] bg-gradient-to-r from-mainGrayTransparent via-[#3f3f3f9a] to-mainGrayTransparent px-9 py-6 backdrop-blur-[10px] lg:mb-24 lg:px-24 lg:py-6'>
			{language === 'english' ? (
				<>
					<h5 className='star-header relative my-6 rounded-lg border border-thinLine bg-[#212121bb] px-4 py-2'>
						<h5 className=''>
					...
					<h5 className='star-header relative my-6 rounded-lg border border-thinLine bg-[#212121bb] px-4 py-2'>
						<h5 className=''>LINE ART INFORMATION</h5>
						<p className='mt-3 text-lg'>
				...
				<>
					...
					<h5 className='star-header relative my-6 rounded-lg border border-thinLine bg-[#212121bb] px-4 py-2'>
						<h5 className=''>ЛАЙН АРТ ИНФОРМАЦИЯ</h5>
						<p className='mt-3 text-lg'>
