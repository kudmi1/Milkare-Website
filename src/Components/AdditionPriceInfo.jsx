...
export default function AdditionPriceInfo() {
	...
	return (
		...
		<div className={`${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'} transition-all duration-500 w-full rounded-md border border-thinLine bg-gradient-to-b from-[#191924ef] to-[#1600419a] bg-opacity-70 px-4 py-6 md:px-12 lg:mb-24 lg:px-24 text-mainText`} >
			{language === 'english' ? (
				<>
