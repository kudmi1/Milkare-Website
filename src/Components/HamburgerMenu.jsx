    ...
    `}
			...
			>
				<div className='relative h-full w-full'>
					<div
						className={`slide-menu absolute right-0 top-0 z-40 w-full bg-gradient-to-r from-mainGray via-[#2b2b2b] to-mainGray py-4 backdrop-blur ${
							hamburgerState
					...
					>
						<div className='mx-auto flex h-full w-full max-w-[600px] flex-col items-center gap-4'>
							...
							<div className='mb-6 grid h-full w-2/3 grid-cols-1 place-items-center gap-4 sm:grid-cols-2 '>
								<button
									className='effect-shine h-12 min-h-[48px] w-full rounded-lg bg-mainGrayTransparent border border-thinLine text-xl'
									onClick={() => {
										setHamburgerState(false)
										setAriaExpanded(false)
									}}
								...
								<button
									className='effect-shine relative flex h-12 min-h-[48px] w-full items-center justify-center rounded-lg bg-mainGrayTransparent border border-thinLine text-xl'
								...
								<button className='effect-shine relative flex h-12 min-h-[48px] w-full rounded-lg bg-mainGrayTransparent border border-thinLine text-xl'>
									<a
