...
export default function GalleryWrapper() {
	...
	return (
		<div className='flex justify-center motion-reduce:transition-none'>
			<div
				className={`relative mt-12 flex w-full max-w-7xl flex-col items-center justify-center rounded-md border-t border-b lg:border border-[#3b3b3b] bg-cardBg bg-opacity-80  lg:w-max`}
			>
