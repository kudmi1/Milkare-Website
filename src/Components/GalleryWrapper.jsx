...
export default function GalleryWrapper() {
	...
	return (
		<div className='flex justify-center motion-reduce:transition-none'>
			<div
				className={`relative mt-12 flex w-full max-w-7xl flex-col items-center justify-center rounded-md border-t border-b lg:border border-[#3b3b3b] bg-gradient-to-b from-[#191924ef] to-[#1600419a] bg-opacity-70 lg:w-max`}
			>
