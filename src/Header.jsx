...
export default function Header() {
	...
	return (
      ...
      ${show ? "top-0" : "-top-40 h-20"}`}
		>
			<div className="header-standart grid w-full max-w-7xl grid-cols-2 items-center justify-between bg-transparent px-0 sm:px-6 md:grid-cols-3 xl:px-0">
				<nav className="hidden max-w-[250px] md:block">
					<ul
        ...
        transition-all duration-300`}
					>
						...
						<li className="dropdown relative " data-dropdown ref={dropdownRef}>
							...
							>
								Contact
								<img src="images/chevron.png" alt="" className="chevron pointer-events-none" />
							</button>
				...
				<div className=" mx-6 flex items-center sm:mx-0 md:justify-center">
					<a
						href="#"
						className={`header-top text-3xl transition-all duration-500 lg:text-5xl`}
					>
						milkare
