...
export default function ToTop() {
	...
	return (
		<div>
			<div
				className={`backdrop-blur=[10px] to-top-btn fixed  bottom-8 right-6 md:bottom-12 md:right-12 z-[200] h-12 w-12 md:h-16 md:w-16 rounded-full bg-[#212121d2] transition-colors ${
					showTopBtn
